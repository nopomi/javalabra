...
/**
 * Kysymys-luokka joka luodaan kun tehdään uusi kysely ja lisätään siihen
 * kysymyksiä
 * @author Miska
 */
...
public class Kysymys {
    ...
    /**
     * Metodi lisää uuden vastauksen kysymykselle ja tallentaa sen käyttäen
     * VastaustenTallentaja-oliota.
     *
    ...
    /**
     * Asettaa kysymykselle kyselyn johon se liittyy, se siis tuntee mihin
     * kyselyyn se kuuluu jos sen metodeja tarvitaan.
     * @param kysely jossa kysymys on
     */
    ...
    /**
     * Metodi palauttaa kyselyn jossa kysymys on.
     * @return Kysely-olio
     */
